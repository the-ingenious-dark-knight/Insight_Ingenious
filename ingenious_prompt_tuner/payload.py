...
async def render_payload(ball_identifier, fs, output_dir, event_type):
    ...
    markdown_content = await fs.read_file(file_name=f'payload_{event_type}_{ball_identifier}.md', file_path=output_dir)
...
def convert_csv_to_md_tables(content):
    ...
    for heading, csv_data in matches_with_heading:
        ...
        processed_content = re.sub(
            pattern, replace_csv_blocks, processed_content,
