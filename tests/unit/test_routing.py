...
class TestRouteManager:
    ...
    def test_register_custom_routes_module_name_comparison(self, mock_import_module):
        ...
        test_cases = [
            ("ingenious.api.routes.custom", False),  # Built-in module - should not register
            ("custom_extension.api.routes.custom", True),  # Custom module - should register
            ("my_extension.api.routes.custom", True),  # Another custom module - should register
        ]
    ...
    def test_register_all_routes_calls_both_methods(self):
        ...
        with patch.object(RouteManager, 'register_builtin_routes') as mock_builtin, \
    ...
    def test_route_manager_methods_are_static_or_class(self):
        ...
        expected_methods = ['register_builtin_routes', 'register_custom_routes', 'register_all_routes']
    ...
    def test_class_methods_have_docstrings(self):
        ...
        public_methods = ['register_builtin_routes', 'register_custom_routes', 'register_all_routes']
        ...
        for method_name in public_methods:
            ...
            assert len(actual_method.__doc__.strip()) > 0, f"{method_name} docstring should not be empty"