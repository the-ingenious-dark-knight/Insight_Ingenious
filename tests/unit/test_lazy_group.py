...
class TestLazyGroup:
    ...
    def test_list_commands_deduplication(self):
        ...
        with patch.object(TyperGroup, 'list_commands', return_value=['dataprep', 'other-cmd']):
            commands = group.list_commands(ctx)
    ...
    def test_get_command_lazy_load_module_not_found(self, mock_echo, mock_import):
        ...
        mock_import.side_effect = ModuleNotFoundError("No module named 'ingenious.document_processing.cli'")
