...
class TestIApiRoutes:
    ...
    def test_concrete_implementation_initialization(self, mock_get_repo, mock_get_logger):
    ...
    def test_docstring_exists(self, mock_get_repo, mock_get_logger):
        ...
        assert "Adds custom routes to the FastAPI app instance" in IApiRoutes.add_custom_routes.__doc__
