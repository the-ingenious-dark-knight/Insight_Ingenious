        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                install_cmd = [
                    ...
                    "install",
                    "-e",
                    f"{self.project_root}[{group}]",
                ]
                subprocess.run(install_cmd, check=True, capture_output=True)

                # Test imports
                for package in test_imports:
                    import_cmd = [str(python_path), "-c", f"import {package}"]
...
class TestDependencyGroups:
    ...
    def test_ai_group(self, dependency_tester):
        ...
        ai_imports = ["autogen_agentchat", "autogen_ext", "openai"]
    ...
    def test_document_processing_group(self, dependency_tester):
        ...
        assert dependency_tester.test_group_installation(
            "document-processing", doc_imports
        )

    @pytest.mark.slow
    def test_ml_group(self, dependency_tester):
        """Test that ml group installs successfully."""
        ml_imports = ["chromadb", "sentence_transformers"]
    ...
    def test_visualization_group(self, dependency_tester):
        ...
        viz_imports = ["matplotlib", "seaborn"]
