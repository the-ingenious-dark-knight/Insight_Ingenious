...
from ingenious.cli.base import (
    BaseCommand, CommandError, ExitCode, create_console
)
from ingenious.cli.registry import CommandRegistry, get_registry
from ingenious.cli.utilities import (
    FileOperations, ValidationUtils, OutputFormatters, ConfigUtils
)
...
class TestValidationUtils:
    ...
    def test_validate_file_extension(self):
        ...
        assert not ValidationUtils.validate_file_extension("test.txt", [".yml", ".yaml"])
