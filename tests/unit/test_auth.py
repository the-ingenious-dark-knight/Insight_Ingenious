...
class TestJWTAuthentication:
    ...
    def test_verify_token_invalid_signature(self):
        ...
        data = {"sub": "testuser", "type": "access", "exp": datetime.utcnow() + timedelta(hours=1)}
    ...
    def test_environment_variables(self):
        ...
        from ingenious.auth.jwt import ACCESS_TOKEN_EXPIRE_MINUTES
        from ingenious.auth.jwt import REFRESH_TOKEN_EXPIRE_DAYS
...
class TestJWTConfiguration:
    ...
    def test_default_configuration(self):
        ...
        from ingenious.auth.jwt import ACCESS_TOKEN_EXPIRE_MINUTES, REFRESH_TOKEN_EXPIRE_DAYS
