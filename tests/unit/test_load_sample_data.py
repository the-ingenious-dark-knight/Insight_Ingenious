...
class TestSqliteSampleDb:
    ...
    def test_init_with_csv_file_exists(self, mock_read_csv, mock_connect, mock_makedirs, mock_exists, mock_get_config):
    ...
    @patch('ingenious.utils.load_sample_data.sqlite3.connect')
    @patch('ingenious.utils.load_sample_data.pd.read_csv')
    def test_init_with_directory_creation(self, mock_read_csv, mock_connect, mock_makedirs, mock_exists, mock_get_config):
        ...
        mock_exists.side_effect = lambda path: path == "/tmp/test.csv"  # Only CSV exists
    ...
    @patch('ingenious.utils.load_sample_data.sqlite3.connect')
    @patch('ingenious.utils.load_sample_data.pd.read_csv')
    def test_create_table_with_different_dtypes(self, mock_read_csv, mock_connect, mock_exists, mock_get_config):
