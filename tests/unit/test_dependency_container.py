...
class TestDependencyContainer:
    ...
    def test_chat_history_repository_provider(self):
        ...
        with patch.object(container.config, "__call__", return_value=mock_config):
            with patch(
                "ingenious.services.container.ChatHistoryRepository"
            ) as mock_repo:
                with patch(
                    "ingenious.services.container._get_database_type"
                ) as mock_db_type:
    ...
    def test_chat_service_factory(self):
        ...
        with patch.object(container.config, "__call__", return_value=mock_config):
            with patch.object(
                container.chat_history_repository, "__call__", return_value=mock_repo
            ):
                with patch(
    ...
    def test_message_feedback_service_provider(self):
        ...
        with patch.object(
            ...
            with patch(
                "ingenious.services.container.MessageFeedbackService"
