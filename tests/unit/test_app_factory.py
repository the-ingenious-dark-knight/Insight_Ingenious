...
class TestFastAgentAPI:
    ...
    def test_init_creates_and_configures_app(self, mock_exception_handlers, mock_route_manager, mock_chdir):
    ...
    @patch('ingenious.main.app_factory.RouteManager')
    @patch('ingenious.main.app_factory.ExceptionHandlers')
    def test_configure_app_calls_all_setup_methods(self, mock_exception_handlers, mock_route_manager, mock_chdir):
        ...
        with patch.object(api, '_setup_dependency_injection') as mock_di, \
...
class TestCreateApp:
    ...
    @patch('ingenious.main.app_factory.RouteManager')
    @patch('ingenious.main.app_factory.ExceptionHandlers')
    def test_create_app_returns_configured_fastapi_app(self, mock_exception_handlers, mock_route_manager, mock_chdir):
    ...
    @patch('ingenious.main.app_factory.RouteManager')
    @patch('ingenious.main.app_factory.ExceptionHandlers')
    def test_create_app_creates_new_fast_agent_api_instance(self, mock_exception_handlers, mock_route_manager, mock_chdir):
