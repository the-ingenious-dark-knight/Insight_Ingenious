...
from autogen_core.models import LLMMessage, UserMessage, AssistantMessage, FunctionExecutionResultMessage, SystemMessage
...
class RoutedAssistantAgent(RoutedAgent, ABC):
    def __init__(self, agent: Agent, data_identifier: str, next_agent_topic: str = None, tools=[]) -> None:
