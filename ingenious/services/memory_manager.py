...
class MemoryManager:
    ...
    async def read_memory(self, thread_id: str = None, default_content: str = "") -> str:
        """
    ...
    async def maintain_memory(self, new_content: str, max_words: int = 150, thread_id: str = None) -> bool:
        """
...
class LegacyMemoryManager:
    ...
    def maintain_memory(self, new_content: str, max_words: int = 150, thread_id: str = None) -> bool:
        """
        Maintain memory by appending new content and keeping only recent words.
