...
class ModernRepositoryFactory:
    ...
    @staticmethod
    def _create_sqlite_repository(config: IngeniousSettings) -> "SQLiteChatHistoryRepository":
    ...
    @staticmethod
    def _create_azuresql_repository(config: IngeniousSettings) -> "AzureSQLChatHistoryRepository":
...
class SQLiteChatHistoryRepository(BaseSQLRepository):
    ...
    def __init__(self, config: IngeniousSettings, query_builder: QueryBuilder, connection_pool: ConnectionPool):
    ...
    async def get_threads_for_user(self, identifier: str, thread_id: Optional[str] = None):
